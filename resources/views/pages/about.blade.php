...
@section('page-title', 'DataDoor | About')
@section('content')
    <body>
...
{{--        <!-- end switcher menu -->--}}
        ...
        <section
            ...
            style="background-image: url(assets/images/background/page-title-3.jpg)"
        >
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                            <div class="image_block_2">
                                <div class="image-box">
                                    ...
                                    <div
                                        class="text wow fadeInLeft animated"
                                        data-wow-delay="00ms"
                                ...
                                <div class="content-box">
                                    ...
                                    <div class="text">
                                        <p>
                                            ...
                                            incididunt labore et dolore magna aliqua enim ad minim
                                            veniam quis nostrud exercitation ullamco laboris aliquip
                                    ...
                                    <div class="btn-box">
                                        <a href="contact.html" class="theme-btn btn-one"
                                        >Contact With Me</a
                                        >
                                    </div>
                                </div>
